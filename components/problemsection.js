      ...
      <div className=" lg:flex items-center">
        <div className="lg:w-1/2">
          ...
          <p className="pharagraph-gray mt-4 text-lg">
            We deliver healthy, all-natural cooked food every day based on the
            nutritional needs of your employees. Employees of your office can
            order delicious Freshkart meals until 10 AM. Food is then delivered
            at noon.
          </p>
          <div className="mt-4">
